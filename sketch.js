...
function setup(){
    ...
    //create drops
    //rain = new Drops(200,300); AQUÍ VA LO QUE TENÍAS EN EL DISPLAY DE LA CLASE DROPS
    var maxDrops = 100;
...
function draw(){
    ...
    //display rain drops PARA MOSTRAR LAS PARTICULAS SE UTILIZA TAMBIÉN UN FOR, PORQUE SI NO SOLO SE MUESTRAN UNA VEZ
    //rain.display();
